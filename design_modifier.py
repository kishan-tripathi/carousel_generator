    ...
    def generate_design_prompt(self, brand_config, carousel_content):
        ...
        try:
            ...
            if include_images:
                ...
                1. If the body-text color is not clearly visible enough on the content background i.e., container ,  make it white if content background (container) is lighter, else make it black if the content background(container) color is darker.
